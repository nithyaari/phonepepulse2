...
icon = Image.open('C:/Users/smm/guvi project2/pulse_data/data/img.png')
st.set_page_config(page_title="Phonepe Pulse Data Visualization | By Nithya",
                   page_icon=icon,
                   layout="wide",
...
st.sidebar.header(":wave: :Navy[**Hello! Welcome to the dashboard**]")
...
with st.sidebar:
    selected = option_menu("Menu", ["Home", "Top Charts", "Explore Data", "About"],
                           ...
                           styles={"nav-link": {"font-size": "20px", "text-align": "left", "margin": "-2px",
                                                "--hover-color": "#6F36AD"},
                                   "nav-link-selected": {"background-color": "#AD71EF"}})
# MENU 1 - HOME
if selected == "Home":
    st.image("C:/Users/smm/Downloads/pulseimg/")
    st.markdown("# :Navy[Data Visualization and Exploration]")
    st.markdown("## :Navy[A User-Friendly Tool Using Streamlit and Plotly]")
    col1, col2 = st.columns([3, 2], gap="medium")
    with col1:
        st.write(" ")
        st.write(" ")
        st.markdown("### :Navy[Domain :] Fintech")
        st.markdown(
            "### :Navy[Technologies used :] Github Cloning, Python, Pandas, MySQL, mysql-connector-python, Streamlit, and Plotly.")
        st.markdown(
            "### :Navy[Overview :] In this streamlit web app you can visualize the phonepe pulse data and gain lot of insights on transactions, number of users, top 10 state, district, pincode and which brand has most number of users and so on. Bar charts, Pie charts and Geo map visualization are used to get some insights.")
    with col2:
        st.image("C:/Users/smm/Downloads/home/")

# MENU 2 - TOP CHARTS
if selected == "Top Charts":
    st.markdown("## :Navy[Top Charts]")
...
if selected == "Explore Data":
    ...
    if Type == "Transactions":
        ...
        with col1:
            ...
            df1['State'] = df2['State']
            merged_df = df1.merge(df2, on='State', how='inner')
        ...
        st.markdown("## :Navy[Top Payment Type]")
        mycursor.execute(
    ...
    if Type == "Users":
        ...
        st.markdown("## :Navy[Overall State Data - User App opening frequency]")
        mycursor.execute(
        ...
        df2 = pd.read_csv('Statenames.csv')
        # Assuming that 'df1' has the same number of rows as 'df2'
        df1['State'] = df2['State']

        # Convert the 'Total_Appopens' column to float if it's not already
        ...
        st.markdown("## :Navy[Select any State to explore more]")
        selected_state = st.selectbox("",
                                      ('andaman-&-nicobar-islands', 'andhra-pradesh', 'arunachal-pradesh', 'assam',
                                       'bihar',
                                       'chandigarh', 'chhattisgarh', 'dadra-&-nagar-haveli-&-daman-&-diu', 'delhi',
...
if selected == "About":
    ...
    with col1:
        st.write(" ")
        st.write(" ")
        st.markdown("### :Navy[About PhonePe Pulse:] ")
        st.write(
        ...
        st.markdown("### :Navy[About PhonePe:] ")
        st.write(
        ...
        st.write("**:Pink[My Project GitHub link]** ⬇️")
        st.write("https://github.com/nithyaari/phonepepulse2.git")
        st.write("**:Pink[Image and content source]** ⬇️")
        st.write(
    ...
    with col2:
        ...
        st.write(" ")
        st.write(" ")
        st.image("C:/Users/smm/Downloads/Pulseimg.jpg/")